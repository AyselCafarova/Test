...
> *STEP-1:* `https://github.com/AyselCafarova/Test.git` <br/>
> *STEP-2:*  enter the `test` folder that appears <br/>
> *STEP-3:*  open the folder you are in in a text editor <br/>
> *STEP-4:*  open the folder with `cmd` or `Git Bash` and write `npm start` <br/>
> *STEP-5:*  to download the project as `.zip`  [here](https://github.com/AyselCafarova/Test/archive/refs/heads/master.zip) click <br/>
...
![There was a screenshot here](./Capture.PNG)
